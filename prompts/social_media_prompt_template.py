...
social_media_posts_over_time_template = PromptTemplate(
    input_variables=["total_engagements", "post_likes_and_reactions", "post_comments", "post_shares", "post_reach",
                     "estimated_clicks", "search_results"],
    template="""
...
social_media_data_highlight_template = PromptTemplate(
    input_variables=["total_engagements", "post_likes_and_reactions", "post_comments", "post_shares", "post_reach",
                     "estimated_clicks", "hourly_engagements"],
    template="""
